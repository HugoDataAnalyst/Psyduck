...
class CacheTimers:
    ...
    def seconds_until_next_hourly_event(self):
    ...
    def seconds_until_half_hour(self):
    ...
    def seconds_until_next_week(self):
    ...
    def seconds_until_next_week_fourpm(self):
    ...
    def seconds_until_next_month(self):
    ...
    def seconds_until_next_month_fourpm(self):
