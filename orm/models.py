...
class QuestSightings(models.Model):
    id = fields.IntField(pk=True)
    pokestop_id = fields.CharField(max_length=255, null=True)
    ar_type = fields.IntField(null=True)
    normal_type = fields.IntField(null=True)
    reward_ar_type = fields.IntField(null=True)
    reward_normal_type = fields.IntField(null=True)
...
class RaidSightings(models.Model):
    id = fields.IntField(pk=True)
    gym_id = fields.CharField(max_length=255, null=True)
    ex_raid_eligible = fields.BooleanField(default=False, null=True)
    is_exclusive = fields.BooleanField(default=False, null=True)
