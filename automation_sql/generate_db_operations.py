...
async def create_procedures():
    ...
    for offset, areas in timezone_groups.items():
        ...
        store_raid_total_sql = await procedure_generator.generate_store_raid_total_sql(areas, offset)
        store_raid_grouped_sql = await procedure_generator.generate_store_raid_grouped_sql(areas, offset)
        store_invasion_total_sql = await procedure_generator.generate_store_invasion_total_sql(areas, offset)
