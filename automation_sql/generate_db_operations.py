...
async def create_procedures():
    ...
    for offset, areas in timezone_groups.items():
        store_pokemon_total_sql = procedure_generator.generate_store_pokemon_total_sql(areas, offset)
        store_pokemon_grouped_sql = procedure_generator.generate_store_pokemon_grouped_sql(areas, offset)
        store_quest_total_sql = procedure_generator.generate_store_quest_total_sql(areas, offset)
        store_quest_grouped_sql = procedure_generator.generate_store_quest_grouped_sql(areas, offset)
        store_raid_total_sql = procedure_generator.generate_store_raid_total_sql(areas, offset)
        store_raid_grouped_sql = procedure_generator.generate_store_raid_grouped_sql(areas, offset)
        store_invasion_total_sql = procedure_generator.generate_store_invasion_total_sql(areas, offset)
        store_invasion_grouped_sql = procedure_generator.generate_store_invasion_grouped_sql(areas, offset)
        store_hourly_pokemon_tth_sql = procedure_generator.generate_store_hourly_pokemon_tth_procedure()
