...
async def create_procedures():
    ...
    for offset, areas in timezone_groups.items():
        ...
        drop_update_daily_surge_sql, update_daily_surge_sql = await procedure_generator.generate_update_daily_surge_procedure(areas, offset)
        drop_update_weekly_surge_sql, update_weekly_surge_sql = await procedure_generator.generate_update_weekly_surge_procedure(areas, offset)
        drop_update_monthly_surge_sql, update_monthly_surge_sql = await procedure_generator.generate_update_monthly_surge_procedure(areas, offset)
